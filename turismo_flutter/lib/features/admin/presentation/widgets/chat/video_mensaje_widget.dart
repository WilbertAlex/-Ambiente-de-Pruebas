...
import 'package:turismo_flutter/features/admin/presentation/widgets/chat/video_desde_bloc_widget.dart';

class VideoMensajeWidget extends StatelessWidget {
    ...
    return Align(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            VideoDesdeBlocWidget(fileName: nombreArchivo),
