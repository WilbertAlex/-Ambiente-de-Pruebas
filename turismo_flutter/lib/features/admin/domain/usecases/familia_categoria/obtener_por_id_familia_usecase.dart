...
class ObtenerPorIdFamiliaUsecase {
  final FamiliaCategoriaRepository familiaCategoriaRepository;
  ObtenerPorIdFamiliaUsecase(this.familiaCategoriaRepository);

  Future<List<FamiliaCategoriaDtoResponse>> call(int idFamilia) async{
    return await familiaCategoriaRepository.obtenerFamiliaCategoriaPorIdFamilia(idFamilia);
  }
}