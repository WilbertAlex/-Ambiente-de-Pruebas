...
class GetCategoriaByIdUsecaseGeneral {
  final CategoriaGeneralRepository categoriaGeneralRepository;
  GetCategoriaByIdUsecaseGeneral(this.categoriaGeneralRepository);

  Future<CategoriaGeneralResponse> call(int idCategoria) async {
    return await categoriaGeneralRepository.getCategoriaByIdGeneral(idCategoria);
  }
}