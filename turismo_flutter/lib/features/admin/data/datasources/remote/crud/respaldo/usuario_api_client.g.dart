...
class _UsuarioApiClient implements UsuarioApiClient {
  ...
  Future<UsuarioIdMensajeDtoResponse> buscarIdPorUsername(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<UsuarioIdMensajeDtoResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/admin/usuarioCompleto/buscarIdPorUsername/${userName}',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late UsuarioIdMensajeDtoResponse _value;
    try {
      _value = UsuarioIdMensajeDtoResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
