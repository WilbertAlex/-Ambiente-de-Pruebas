        ...
        stage('Clone') {
            steps {
                timeout(time: 2, unit: 'MINUTES') {
                    git branch: 'main', credentialsId: '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', url: 'https://github.com/WilbertAlex/-Ambiente-de-Pruebas.git'
                }
            }
        }
