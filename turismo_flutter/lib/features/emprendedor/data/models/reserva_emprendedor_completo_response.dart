import 'package:turismo_flutter/features/emprendedor/data/models/reserva_detalle_emprendedor_completo_response.dart';
...
class ReservaEmprendedorCompletoResponse {
  final int idReserva;
  ...
  final List<ReservaDetalleEmprendedorCompletoResponse> reservaDetalles;
  final DateTime? fechaCreacionReserva;
  final DateTime? fechaModificacionReserva;

  ReservaEmprendedorCompletoResponse({
  ...
  factory ReservaEmprendedorCompletoResponse.fromJson(Map<String, dynamic> json) {
    return ReservaEmprendedorCompletoResponse(
      ...
      reservaDetalles: (json['reservaDetalles'] as List<dynamic>)
          .map((e) => ReservaDetalleEmprendedorCompletoResponse.fromJson(e))
          .toList(),
