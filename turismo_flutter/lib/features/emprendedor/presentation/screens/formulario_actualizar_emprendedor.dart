...
class FormularioActualizarEmprendedor extends StatefulWidget {
  final UsuarioEmprendedorResponse usuario;

  const FormularioActualizarEmprendedor({super.key, required this.usuario});

  @override
  State<FormularioActualizarEmprendedor> createState() => _FormularioActualizarEmprendedorState();
}

class _FormularioActualizarEmprendedorState extends State<FormularioActualizarEmprendedor> {
  ...
  void _submit() async {
    ...
    final dto = UsuarioEmprendedorDto(
    ...
    context.read<UsuarioEmprendedorBloc>().add(
      PutUsuarioEmprendedorEvent(dto, _imagen),
    );
