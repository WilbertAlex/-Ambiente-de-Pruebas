...
public class Reserva {
    ...
    @JsonBackReference(value = "usuario-reserva") // <-- agrega el value
    private Usuario usuario;

    @ManyToOne
    @JoinColumn(name = "emprendimiento_id", nullable = false)
    @JsonBackReference(value = "emprendimiento-reserva") // <-- agrega el value
    private Emprendimiento emprendimiento;

    @JsonManagedReference(value = "reserva-detalles")
